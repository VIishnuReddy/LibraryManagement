...
import com.example.library.factories.BookingFactory;
...
@Service
public class RentStrategy implements BookingStrategy{

    private UserRepository userRepository;
    private BookRepository bookRepository;
    private BookItemRepository bookItemRepository;

    public RentStrategy(UserRepository userRepository,
    ...
    public BookItem processTransaction(Long userId, Long bookId) {
        ...
        BookItem bookItem = BookItemFactory.create(book, user, TransactionType.RENT);
